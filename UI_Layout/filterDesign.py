...
class Ui_FilterDesigner(object):
    def setupUi(self, FilterDesigner):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/appIcon/processing.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        sizePolicy.setHeightForWidth(self.unitCirclePlot.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.zPlaneDesignControls.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, FilterDesigner):
        ...
        self.applicationGraphs.setTitle(_translate("FilterDesigner", "Application Signals"))
        self.mousePadGroupBox.setTitle(_translate("FilterDesigner", "Mouse Pad"))
        self.label.setText(_translate("FilterDesigner", "Generate signal by moving your mouse"))
        self.generateSignal.setText(_translate("FilterDesigner", "Generate Signal"))
        self.filterDesignGroupBox.setTitle(_translate("FilterDesigner", "Filter Design"))
        self.zPlaneDesignControls.setTitle(_translate("FilterDesigner", "Design Controls"))
        ...
        self.addConjugatesCheckBox.setText(_translate("FilterDesigner", "Add Conjugates"))
        self.applyFilterButton.setText(_translate("FilterDesigner", "Apply Filter"))
        self.allPassDesignGroupBox.setTitle(_translate("FilterDesigner", "All-Pass FilterDesign"))
        ...
        self.applyFilterButton_2.setText(_translate("FilterDesigner", "Apply All-Pass Filter"))
        self.frequencyResponseGroupBox.setTitle(_translate("FilterDesigner", "Frequency Response"))
